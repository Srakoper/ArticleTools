...
def selectBooks():
    ...
    if details:
        ...
        for book in enumerate(sorted_books, start=1): print("{:>4} {}".format(book[0], book[1]))
    while True:
        try:
            ...
            print("\nSelected books:\n")
            for book in selected_books: print(book)
        ...
        if re.search(r"(\.epub)|(\.mobi)", book):
            ...
            for word in re.sub(r"[,\-!'_()]", "", book[:-5]).split():
                if word not in ("a", "an", "and", "as", "at", "by", "das", "de", "degli", "dei", "del", "dell", "della",
                                ...
                                "or", "the", "to", "tr.", "un", "una", "une", "uno", "unas", "unos", "ur.", "van",
                                "von", "with") and word[0].islower():
                    noncapitalized = True
...
while True:
    while True:
        choice = input("{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}"
                       .format("\n0: enter new path",
                               "\n1: refresh and print out list of books from path",
        ...
        if choice == "X" or choice == "x": quit()
            ...
            try:
                ...
                if number == 1:
                    print()
                    books = getBooks(path)
                    for book in enumerate(books, start=1): print("{:>4} {}".format(book[0], book[1]))
                    print("\nList of books from path {} refreshed.".format(path))
                    break
                if number == 2:
                    print()
                    books = selectBooks()
